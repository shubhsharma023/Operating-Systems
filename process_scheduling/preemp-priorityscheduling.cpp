...
class process /*Created this class for not creating loop for every process*/
{
public:
    int pid;
    int arrival_time;
...
int main()
{
    ...
    memset(is_completed, 0, sizeof(is_completed)); /*different value stored in different memory set block*/
